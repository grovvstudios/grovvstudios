...
export function Hero() {
  return (
    // FIX 1: Layout Strategy (Padding-Based instead of Center-Based)
    // - 'pt-48' (Mobile) & 'md:pt-64' (Desktop): Forces content down, guaranteeing it clears the Navbar.
    // - 'pb-32': Adds space at bottom for Stats boxes.
    // - 'overflow-visible': Ensures nothing gets clipped.
    <section className="relative w-full overflow-visible min-h-screen flex flex-col justify-start items-center px-4 pt-48 pb-32 md:px-6 md:pt-64 md:pb-40">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="relative mb-8 inline-block max-w-full">
          <motion.h1
            ...
            // WRAPPING: Wraps on phone, Single line on laptop
        ...
        <motion.div
          ...
          // FIX 2: Button Sizing
          // - Removed 'w-full' from parent container. 
          // - Added 'w-auto' to buttons so they don't stretch.
        ...
        >
          <button
            ...
            // FIX 3: Hover Fix
            // - Removed 'animate-btn-pulse-wait' because it breaks hover scaling.
            // - Added 'hover:scale-105' and 'transition-transform'.
            // - Added 'w-[200px]' (fixed width) or 'w-auto' to prevent them from being "too big".
            className="group px-8 py-4 rounded-2xl transition-all duration-300 hover:shadow-2xl hover:scale-105 flex justify-center items-center w-auto md:w-auto"
            style={{
              background: "linear-gradient(135deg, #1a1a2e 0%, #667eea 50%, #764ba2 100%)",
              color: "white",
              fontWeight: 600
          ...
          <button
            ...
            className="px-8 py-4 rounded-2xl transition-all duration-300 hover:scale-105 text-gray-700 font-medium hover:bg-gray-50 border border-gray-200 w-auto md:w-auto"
            style={{
        ...
        {/* Stats cards (SQUARE + ANIMATED BORDER + VISIBILITY FIX) */}
        <motion.div
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 1, delay: 0.8 }}
          // FIX 4: Visibility & Layout
          // - 'relative z-20': Forces stats ON TOP of section dividers/backgrounds.
          // - 'mt-20': Consistent spacing.
          // - 'grid-cols-1': Stacked on mobile. 'md:grid-cols-3': Row on desktop.
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        <motion.div
          ...
          // - 'w-full md:w-auto': Full width on mobile, auto width on desktop to prevent stretching
        ...
        >
          <button
            ...
            // FIX 2b: Button Sizing
            // - 'w-full md:w-auto': Prevents stretching on desktop
            // - 'px-8 py-4': Comfortable padding
            className="group animate-btn-pulse-wait w-full md:w-auto px-8 py-4 rounded-2xl transition-all duration-300 hover:shadow-2xl flex justify-center items-center"
            style={{
              background: "linear-gradient(135deg, #1a1a2e 0%, #667eea 50%, #764ba2 100%)",
              color: "white",
              fontWeight: 600
          ...
          <button
            ...
            className="w-full md:w-auto px-8 py-4 rounded-2xl transition-all duration-300 hover:scale-105 text-gray-700 font-medium hover:bg-gray-50 border border-gray-200"
            style={{
              background: "rgba(255, 255, 255, 0.8)",
              backdropFilter: "blur(10px)",
            }}
