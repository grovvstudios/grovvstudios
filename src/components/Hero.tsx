...
export function Hero() {
  return (
    // FIX 1: Padding & Layout
    // - 'pt-40': Base padding for mobile to clear navbar
    // - 'md:pt-48': Increased padding for desktop to ensure clearance
    // - 'min-h-screen': Ensures full height but allows scrolling
    // - 'h-auto': Allows content to push down naturally
    // - 'justify-start': Prevents vertical centering from hiding top content
    <section className="relative w-full overflow-visible min-h-screen h-auto flex flex-col justify-start items-center px-4 pt-40 pb-20 md:px-6 md:pt-48 md:pb-40">
